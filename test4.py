...
# Retrieve bigrams from Cluster 1 and Cluster 2
cluster_1_bigrams = [cluster['bigram'] for cluster in clusters[:n_bigrams-1] if cluster['size'] == 1]
cluster_2_bigrams = [cluster['bigram'] for cluster in clusters[:n_bigrams-1] if cluster['size'] == 2]

print("\nBigrams in Cluster 1:")
for bigram in cluster_1_bigrams:
    print(bigram)

print("\nBigrams in Cluster 2:")
for bigram in cluster_2_bigrams:
    print(bigram)
